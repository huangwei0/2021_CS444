...
main(int argc, char *argv[]){
	...
	//We are at the end of the file. We backup yo just before the a
	...
	//We seek 5000 character past the end of the file and
	...
	//We try to move to before the begining of the file.
